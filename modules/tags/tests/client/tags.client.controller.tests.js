  ...
  describe('Tags Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleTagPostData = new TagsService({
          name: 'Tag Name'
        });

        $scope.vm.tag = sampleTagPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (TagsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('tags.view', {
          tagId: mockTag._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        // Mock Tag in $scope
        $scope.vm.tag = mockTag;
      });

      it('should update a valid Tag', inject(function (TagsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (TagsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Tag and redirect to Tags', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('tags.list');
      });

      it('should should not delete the Tag and not redirect', function () {
